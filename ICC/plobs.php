...
<div  class="cld">
  ...
  <thead role="rowgroup">
    <tr role="row">
      ...
      <th role="columnheader">Respose </th>
  ...
  <tbody role="rowgroup">
    <?php 
    $op = $_SESSION['id'];
    $ret=mysqli_query($con,"select * from prob where uid2 = '$op' ");
                $cnt=1;
    ...
    <tr role="row">
      ...
      <td role="cell"><?php echo $row['redate'];?></td>
       <td role="cell"><?php echo $row['respo'];?></td>
